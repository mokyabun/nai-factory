...
const settingsModule =
    require('../../src/services/settings') as typeof import('../../src/services/settings')
const novelaiModule =
    require('../../src/services/novelai') as typeof import('../../src/services/novelai')
const imageModule = require('../../src/services/image') as typeof import('../../src/services/image')
const vibeImageModule =
    require('../../src/services/vibe-image') as typeof import('../../src/services/vibe-image')
...
const checkVibesForProjectMock = mock(
    async () =>
        [] as ReturnType<typeof vibeImageModule.checkVibesForProject> extends Promise<infer T>
            ? T
            : never,
)
...
const { runJob } =
    require('../../src/services/queue-runner') as typeof import('../../src/services/queue-runner')
